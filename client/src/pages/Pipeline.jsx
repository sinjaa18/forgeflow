        ...
        <div className="p-6">
          ...
          <div className="flex overflow-x-auto pb-4 gap-4">
            {statuses.map((status) => (
              ...
              >
                <h2 className="text-xl font-bold sticky top-0 px-1 mb-3 bg-slate-800 border border-gray-500 rounded">{status}</h2>
                <div className="space-y-4">
                  {leads
                    ...
                    .map((lead) => (
                      <div
                        key={lead._id}
                        className="bg-slate-800 p-4 rounded-lg w-full"
                      >
